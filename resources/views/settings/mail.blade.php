...
@section('content')
    ...
    <div class="alert alert-warning">
        Guzelhosting aynı PDF ekini kısa aralıkla farklı kişilere göndermeyi toplu mail sayıp <code>550 5.7.1</code> ile keser.
        Sistem her giden mailden sonra bekler; konu ve gövde her gönderimde farklılaşır. Test için Gmail / Outlook / kurumsal adrese aynı anda basmayın.
    </div>
                ...
                <form method="POST" action="{{ route('settings.mail.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-text">Guzelhosting, aynı boyutta ekle peş peşe gönderimi mass-mail sayar. Açık olsa bile mailler arasında beklenir; fatura linki her durumda gider.</div>
                        </div>
                        <div class="col-md-6">
