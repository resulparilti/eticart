...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'uyumsoft_entity_prefix', 'value' => '', 'category' => 'uyumsoft', 'label' => 'UyumSoft Koşullu Cari Ön Ek'],
            ['key' => 'uyumsoft_doc_tra_code', 'value' => 'ST-101', 'category' => 'uyumsoft', 'label' => 'UyumSoft Hareket Kodu'],
            ['key' => 'uyumsoft_co_code', 'value' => '', 'category' => 'uyumsoft', 'label' => 'UyumSoft Firma Kodu'],
            ['key' => 'uyumsoft_unit_code', 'value' => 'ADET', 'category' => 'uyumsoft', 'label' => 'UyumSoft Birim Kodu'],
            ['key' => 'uyumsoft_order_line_include_title', 'value' => '1', 'category' => 'uyumsoft', 'label' => 'UyumSoft satırda ürün adı'],
            ['key' => 'uyumsoft_order_line_include_variant', 'value' => '1', 'category' => 'uyumsoft', 'label' => 'UyumSoft satırda varyant'],
            ['key' => 'uyumsoft_order_line_include_barcode', 'value' => '1', 'category' => 'uyumsoft', 'label' => 'UyumSoft satırda barkod'],
            ...
            ['key' => 'sync_orders_interval', 'value' => '5', 'category' => 'sync', 'label' => 'Sipariş Sync (dk)'],
            ['key' => 'sync_products_interval', 'value' => '15', 'category' => 'sync', 'label' => 'Ürün Sync (dk)'],
            ['key' => 'sync_stock_interval', 'value' => '5', 'category' => 'sync', 'label' => 'Stok Sync (dk)'],
            ['key' => 'sync_cargo_interval', 'value' => '15', 'category' => 'sync', 'label' => 'Kargo Sync (dk)'],
            ['key' => 'sync_uyumsoft_orders_interval', 'value' => '5', 'category' => 'sync', 'label' => 'UyumSoft Sipariş Sync (dk)'],
